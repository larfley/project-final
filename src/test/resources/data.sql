...
insert into USERS (ID, PASSWORD, FIRST_NAME, LAST_NAME, DISPLAY_NAME)
values ('1', '{noop}password', 'userFirstName', 'userLastName', 'userDisplayName'),
       ('2', '{noop}admin', 'adminFirstName', 'adminLastName', 'adminDisplayName'),
       ('3', '{noop}guest', 'guestFirstName', 'guestLastName', 'guestDisplayName'),
       ('4', '{noop}manager', 'managerFirstName', 'managerLastName', 'managerDisplayName');
